  ...
  return (
    <div className="min-h-screen background-color border rounded-xl text-white p-4 flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl background-color p-6 rounded-xl shadow-xl mb-6">
        <h3 className="text-2xl font-bold mb-6 text-white">In Rupee</h3>
          ...
          <table className="w-full text-left table-auto">
            <thead>
              <tr className="bg-gray-700 text-white">
                ...
                <th className="p-4 border-b border-gray-500">Amount In INR</th>
            ...
            <tbody>
              ...
              <tr className="text-center text-gray-400">
                <td className="p-4" colSpan="7">Result Not Found</td>
              </tr>
              ...
              <tr className="bg-gray-700 text-white">
                ...
                <td className="p-4 border-t border-gray-500" colSpan="6">(0.00 ₹) (0.00 $)</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default Admin_Request_History;